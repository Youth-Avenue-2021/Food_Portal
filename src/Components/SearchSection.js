  ...
  return (
    <>
      <div className="flex min-h-[30rem] flex-col bg-sky-200 items-center justify-center">
        <h1 className="pb-14 text-7xl text-sky-700">Find 100+ Food Mess!</h1>
        <form className="w-full mx-auto text-center">
          <input type="text" className={`md:w-[40rem] p-5 duration-200 border-2 border-transparent rounded-md w-[85%] shadow-md focus:shadow-xl outline-none focus:border-sky-700`} placeholder="Search for food mess" />
